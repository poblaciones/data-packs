...
1. Realizar la instalación de una base de datos vacía de Poblaciones (con el script del repositorio /poblaciones/startup/dbscript-v3.10.sql).

2. Expandir el archivo argentina.zip (incluyendo los archivos z01, z02, z03 y z04). Ejecutar el script data-pack-v3.10.sql allí contenido.
